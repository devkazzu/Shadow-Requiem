...
- Reworked the lobby overlay into an original modern 3D/MOBA-style HUD with beveled glass/holographic depth, compact profile/currency/system controls, Shop/Events/Starlight/Missions/Friends/Guild shortcuts, preserved promotional banner, friends panel, chat preview, Ranked/Classic selector, Vault/Weapon/Preset/Collection/Lab bottom nav, and large glowing START button.
